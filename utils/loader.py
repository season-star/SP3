...
class DatasetManager(object):
    ...
    def __init__(self, args):
        ...
        self.__slot_alphabet0 = Alphabet('slot', if_use_pad=False, if_use_unk=False)
    ...
    @property
    def slot_alphabet_list(self):
        return deepcopy(self.__slot_alphabet_list)
    ...
    def quick_build(self):
        ...
        for i in range(len(self.__slot_alphabet_list)):
            self.__slot_alphabet_list[i].save_content(alphabet_dir)
    ...
    def add_file(self, file_path, data_name, if_train_file):
        ...
        if if_train_file:
            for dial_data_detail in data_detail:
                for turn_data_detail in dial_data_detail:
                    ...
                    curr_slot_alphabet.add_instance(turn_data_detail['slot'])
        ...
        # Record the raw text of dataset.
        # print(len(self.__word_alphabet)) # 87
        # print(self.__text_triple_alphabet) # 102
        # print(self.__history_alphabet) # 124
        ...
        for digit_dialogue_index in range(len(self.__digit_data_detail[data_name])):
            for digit_turn_index in range(len(self.__digit_data_detail[data_name][digit_dialogue_index])):
                ...
                if if_train_file:
                    ...
                    curr_slot_alphabet = self.__slot_alphabet_list[intent_index]
                    self.__digit_data_detail[data_name][digit_dialogue_index][digit_turn_index]['slot'] = curr_slot_alphabet.get_index(curr_detail['slot'])
    ...
    def batch_delivery(self, data_name, batch_size=None, is_digital=True, shuffle=True):
        ...
        # for thing in dialogue_detail[0]:
        #     print(thing)
